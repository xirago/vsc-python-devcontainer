...
def list_ec2_regions():
    ...
    try:
        ...
        response = ec2_client.describe_regions(
            AllRegions=False
        )  # Set to True to see all possible regions including those not opted-in
        ...
        if error_code == "AuthFailure":
            ...
            print(
                "This could be due to network issues, service unavailability or invalid request parameters."
            )
